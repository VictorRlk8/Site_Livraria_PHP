...
insert into tbl_categoria -- insere na tabela categoria!
...
inner join tbl_categoria
  ...
  select * from vw_livro where nm_livro like '%ux%';
  
  select nm_livro,vl_preco,ds_capa from vw_livro where ds_categoria = 'Dados';
  select nm_livro,vl_preco,ds_capa from vw_livro where ds_categoria = 'Mobile';
...
select * from vw_venda where cd_cliente= 4;


drop table tbl_venda;
  
  insert into tbl_usuario 
  values(default, 'Samuel Kara de Pastel', 'samuel@gmail.com','pastel', 1, 'Rua Salvinhos, 88', 'Paranapiacaba','88208-208');
  
   insert into tbl_usuario 
  values(default, 'Giovanni Splinter', 'Giovanni@gmail.com','turtle', 1, 'Rua Bueiros, 99', 'Nova York','78978-310');
  
   insert into tbl_usuario 
  values(default, 'Ronaldo Kamikaze', 'Ronaldo@gmail.com','serial', 0, 'Rua Domingos, 50', 'Santos','67543-678');
...
CREATE USER 'ead'@'localhost' IDENTIFIED WITH mysql_native_password BY '1234567';
